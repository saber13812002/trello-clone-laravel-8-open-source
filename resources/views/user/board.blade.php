        ...
        <div class="bcategory-list" data-list-id="{{ $list['id'] }}">
            <div class="panel panel-default">
                <div class="panel-heading" style="border-bottom: 0px; ">
                    <div class="row">
                        <div class="col-lg-10">
                            <h3 class="panel-title board-panel-title" data-pk="{{ $list['id'] }}">
                                {{ $list['list_name'] }}</h3>
                        </div>
                        <div class="col-lg-2">
                            <span data-listid="{{ $list['id'] }}" class="glyphicon glyphicon-trash delete-list"
                                aria-hidden="true" style="cursor: pointer; top: 3px;"></span>
                        </div>
                    </div>
                </div>
                <div class="panel-body card-list-con frame">
                    <ul class="list-group">
                        <div class="card-con" data-listid="{{ $list->id }}">
                            ...
                            <li class="list-group-item board-list-items" id="card_{{ $card['id'] }}"
                                data-cardid="{{ $card['id'] }}" data-toggle="modal" href="#card-detail"
                                @if(!empty($card["card_color"]))
                                style="border-top: 5px solid #{{ $card['card_color'] }};" @endif>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p style="margin-bottom: 0px;" class="pull-right">{{ $card['card_title'] }}</p>
                                        <ul class="card-description-intro list-inline pull-right">
                                            ...
                                            <li id="card_description">
                                                <a href="#" data-placement="bottom" data-toggle="tooltip"
                                                    title="This card has a description."><span
                                            ...
                                            <li id="totalTasks">
                                                <a href="#" data-placement="bottom" data-toggle="tooltip"
                                                    title="This card have {{ $x['totalTasks'] }} tasks."
                                                    data-totaltask="{{ $x['totalTasks'] }}"><span
                                                        class="glyphicon glyphicon-check" aria-hidden="true"></span></a>
                                            </li>
                                            @endif
                                            @endif
                                            @endforeach
                                            ...
                                            <li id="totalComments">
                                                <a href="#" data-placement="bottom" data-toggle="tooltip"
                                                    title="This card have {{ $card['totalComments'] }} comments."
                                                    data-totalComments="{{ $card['totalComments'] }}"><span
                                            ...
                                            <li id="ownerName">
                                                <a href="#" data-placement="bottom" data-toggle="tooltip"
                                                    title="مدیر کارت: {{ $card['ownerName'] }} ."
                                                    data-totalComments="{{ $card['ownerName'] }}"><span
