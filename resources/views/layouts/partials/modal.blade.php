            ...
            <div class="modal-body">
                <form action="" method="POST" role="form" class="create-board-form">
                    ...
                    <div class="form-group">
                        <h4>گروه</h4>
                        <p>
                            گروه اجازه میده که شما کارها و بورد های گروه رو ببینید به نظر میرسه شما عضو هیچ گروهی نیستید
                            <a data-toggle="modal" href='#create-team'>یک گروه بسازید</a>.
                        </p>
                    </div>
                    ...
                    <div class="form-group" id="boardPrivacyTypeCon">
                        <p><span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span> این بورد خصوصی خواهد
                            بود</p>
                    ...
                    <div class="panel-body">
                        <form action="" method="POST" role="form" class="create-group-form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="group-description" class="form-control" rows="3"
                                    required="required"></textarea>
                            </div>
                            <hr>
                            <div class="form-group">
                                <p>
                                    یک گروه شامل افراد و بورد های مرتبط با شماست. کمک میکنه برای سازمان دهی و مدیریت
                                    بهتر کارها
                                </p>
                                <br />
                                <p>
                                    <input type="radio"> گزینه ی <b>بیزینس کلاس </b>برای امنیت بالاتر و مدیریت بهتر
                                    عضویت را ارتقا دهید </input>
                                </p>
                            </div>
                        </form>
                    </div>
            ...
            <div role="tabpanel">
                <div class="modal-header" style="border-bottom: none; padding-bottom: 0px !important;">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation">
                            <a href="#subtasks" aria-controls="tab" role="tab" data-toggle="tab">کارهای مرتبط و
                                وابسته</a>
                        </li>
                        <li role="presentation">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="general">
                            <form action="" method="POST" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="#" data-type="text" class="input-editable editable-click"
                                        title="{{ trans('board.EnterCardTitle') }}"
                                        id="card_title_editable">{{ trans('board.Empty') }}</a>
                                </div>
                                <div class="form-group">
                                    <label for="">توضیحات</label>
                                    <a href="#" data-type="textarea" class="input-editable editable-click"
                                        title="{{ trans('board.EnterCardDescription') }}"
                                        id="card_description_editable">{{ trans('board.Empty') }}</a>
                                </div>
                                <div class="form-group">
                        ...
                        <div role="tabpanel" class="tab-pane" id="date">
                            ...
                            <form action="" method="POST" role="form" style="height: 65px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h1 class="label" style="color: #333333; padding-left: 0px; font-size: 16px;">
                                            ساخته شده در تاریخ: </h1>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1"><span
                                                    class="glyphicon glyphicon-calendar"
                                                    aria-hidden="true"></span></span>
                                            <input type='text' class="form-control ui-datepicker"
                                                data-format="dd-MM-yyyy hh:mm:ss" id='due-date'
                        ...
                        <div role="tabpanel" class="tab-pane" id="subtasks">
                            ...
                            <div class="addSubTaskCon">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control task-title" id="task-description-input"
                                        required="required">
                            ...
                            <div class="row" style="margin-top: 19px; margin-bottom: 19px;">
                                <div class="col-lg-8 col-lg-offset-2">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped per-tasks-completed"
                            ...
                            <div class="task-list-con frame"
                                style="margin-top: 12px; max-height: 235px; overflow: scroll;"></div>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="comments">
                            <div class="row" style="margin-top: 13px;">
                                <div class="col-lg-12">
                                    <h1 style="font-family: monospace; font-size: 23px; font-weight: 700; margin: 0;">
                                        اظهار نظرها: </h1>
                                    ...
                                    <form method="POST" role="form" role="form">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <div class="form-group">
                                                    <textarea name="adasd" id="comment-input" class="form-control"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="save-change">ذخیره تغییرات</button>
                    <button type="button" class="btn btn-danger" id="delete-card"><span
                            class="glyphicon glyphicon-trash" aria-hidden="true"></span> پاک کردن</button>
                </div>
            </div>
        </div>
    </div>
