$(document).ready(function() {
    var Board = {
                ...
                $(el).editable({
                    ...
                    ajaxOptions: {
                        ...
                        success: function() {
                            ...
                            that.createActivity(listId, 'board_list', 'ویرایش نام لیست');
                        }
                    }
                });
            }); 
        ...
        deleteList: function(listId, listTrash) {
            ...
            swal({   
                title: "مطمئن هستید؟",   
                text: "شما دیگر قادر به برگرداندن کارت ها و لیست نخواهید بود ",   
                type: "warning",   
                ...
                closeOnConfirm: false 
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            swal("پاک شد!", "با موفقت برای همیشه پاک شد!", "success");
                            that.createActivity(listId, 'board_list', 'deleted a list');
                        },
                        error: function (error) {
                            var response = JSON.parse(error.responseText);
                            swal("اوه", "اتصال به سرور نیست. مجدد آزمایش کنید!", "error");
                        }
                    });
            });
        },
        ...
        updateTaskCompleted: function (taskId, isCompleted) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(document).find(".per-tasks-completed").find(".show").text(perTaskCompleted+"% کارها انجام شده");
                    setTimeout(function () {
            ...
            swal({   
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            swal("پاک شد!", "با موفقیت برای همیشه پاک شد!", "success");
                        },
                        error: function (error) {
                            var response = JSON.parse(error.responseText);
                            swal("اوه", "اتصال به سرور از بین رفت لطفا اتصال را بررسی کنید و مجدد تست کنید!", "error");
                        }
                    });
            });
        },
